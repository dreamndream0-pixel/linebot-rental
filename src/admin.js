...
function propertyFormHtml(p, isModal) {
  ...
  return (
    ...
    '<div class="prop-form-section">' +
      '<h4>描述與照片</h4>' +
      '<div style="display:flex;flex-direction:column;gap:12px;">' +
        '<div class="prop-field"><label>描述</label><textarea id="f_desc" rows="3" placeholder="採光良好，含冷氣熱水器，近捷運站..." oninput="savePropDraft()">' + esc(p ? p.description : '') + '</textarea></div>' +
        '<div class="prop-field"><label>照片</label>' +
