...
const DEFAULT_FEATURES = { bot: true, site: true, heroSlides: true, booking: true, repair: true, community: true, csvImport: true, social: true, broadcast: true, rentReminder: true, ragic: false, smartlock: false }
